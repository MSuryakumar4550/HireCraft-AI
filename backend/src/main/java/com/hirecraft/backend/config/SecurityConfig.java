...
import com.hirecraft.backend.security.CustomUserDetailsService;
import com.hirecraft.backend.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow local development and deployed Vercel frontend domains
        configuration.setAllowedOriginPatterns(List.of(
            "http://localhost:*",
            "https://*.vercel.app",
            "https://hirecraftai-eosin.vercel.app"
        ));
